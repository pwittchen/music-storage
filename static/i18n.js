...
const STRINGS = {
  en: {
    ...
    tokenHint: "The token is kept in this browser only.",
    ...
    tokenRequired: "An auth token is required to upload.",
  ...
  pl: {
    ...
    tokenLabel: "Token",
    tokenHint: "Token zostaje tylko w tej przeglądarce.",
    ...
    tokenRequired: "Do wysyłania potrzebny jest token.",
